"""Launch the CUDA-based obstacle detection node with a parameter file."""
...
def generate_launch_description():
    ...
    params_file_arg = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_share, "config", "params_cuda.yaml"]
        ),
        description="Path to the CUDA-node parameter YAML file",
    )
